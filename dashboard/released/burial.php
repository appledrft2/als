      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <form method="POST" action="export_burial.php">
            ...
            <table id="table1" class="table table-bordered">
              <thead>
               ...
               <tbody>
                  ...
                  <?php 
                    $sql = "SELECT id,release_date,assistance_type,total,timestamp FROM tbl_released  WHERE assistance_type = 'Burial Needs'ORDER BY timestamp ASC";
