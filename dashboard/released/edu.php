    ...
    <section class="content-header">
        <div class="row">
          <h3 class="col-md-6 text-left">
            <span class="text-left">Educational Assistance Beneficiaries (Released)</span>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <form method="POST" action="export_edu.php">
            ...
            <table id="table1" class="table table-bordered">
              <thead>
               ...
               <tbody>
                  ...
                  <?php 
                    $sql = "SELECT b.id,b.firstname,b.middlename,b.lastname,b.purok,b.barangay,b.city,c.assistance_type,b.contact,b.status,c.timestamp,c.amount,b.release_date,c.id FROM tbl_beneficiary AS b INNER JOIN tbl_client AS c ON c.id = b.client_id WHERE c.assistance_type = 'Educational Support' AND b.status = 'Released' ORDER BY timestamp ASC";
