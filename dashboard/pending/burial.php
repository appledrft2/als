            ...
            <table id="table1" class="table table-bordered">
              <thead>
               ...
               <tbody>
                  ...
                  <?php 
                    $sql = "SELECT b.id,b.firstname,b.middlename,b.lastname,b.purok,b.barangay,b.city,c.assistance_type,b.contact,b.status,c.timestamp,c.amount,c.id,b.smsnotify FROM tbl_beneficiary AS b INNER JOIN tbl_client AS c ON c.id = b.client_id WHERE c.assistance_type = 'Burial Needs' AND b.status = 'Pending' ORDER BY timestamp ASC";
